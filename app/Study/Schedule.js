...
const PracticeSchedule = () => {
  ...
  const fetchData1 = async () => {
    try {
      const response = await fetch(`http://localhost:3000/education/study-schedule/${studentId}`);
              ...
              <View style={styles.enrollContainer}>
                ...
                <View style={styles.profileGrid}>
                  ...
                  <View style={styles.profileInfo}>
                    ...
                    <Text style={styles.profileTextName}>{Name}l</Text>
                  </View>
                </View>
